...
public class UserActionsRegistrar
{
  public void registerActions(IActionRegistrator registrator)
  {
    ...
    registrator.registerUserAction(datetimewithzones.actions.formatDateTime.class);
    registrator.registerUserAction(datetimewithzones.actions.isValidTimeZone.class);
